 ...
 */
class VDestinoPreoperatorioForm extends PreoperatorioForm
{
    public function configure()
    {
        ...
        unset($this->widgetSchema['preo_fecha_cirugia']);
        unset($this->widgetSchema['preo_hora_cirugia']);
        unset($this->widgetSchema['preo_enf_codigo']);
        unset($this->widgetSchema['preo_observaciones']);
        ...
        unset($this->validatorSchema['preo_fecha_cirugia']);
        unset($this->validatorSchema['preo_hora_cirugia']);
        unset($this->validatorSchema['preo_enf_codigo']);
        unset($this->validatorSchema['preo_observaciones']);
